...
<h1 align="center">InovChat Frontend</h1>

<p align="center">
  Modern web interface for the InovChat Community — built with React, TypeScript and Vite.
</p>
...
**InovChat Frontend** is the web interface of the InovChat Community — a modern React application providing the full user experience for conversations, contacts, agents, channels, automations, reports, and settings.

Built with React 19, TypeScript, Vite, TailwindCSS 4 and an in-house design system, it delivers a fast, accessible, dark-mode-first experience aligned with the InovChat visual identity.

## Part of the InovChat Community

InovChat Frontend is part of the [InovChat Community](https://github.com/evolution-foundation/evo-crm-community) ecosystem maintained by Evolution Foundation. To use the full stack, clone the umbrella repository with submodules:
...
- **Node.js** 18+
- **pnpm** 8+
- **InovChat Backend** (`evo-ai-crm-community`) running
...
InovChat Frontend is licensed under the Apache License 2.0, with additional brand-protection conditions. See [LICENSE](./LICENSE) for details.

## Trademarks

"Evolution Foundation", "Evolution" and "InovChat Frontend" are trademarks of Evolution Foundation. See [TRADEMARKS.md](./TRADEMARKS.md) for the brand assets policy.
